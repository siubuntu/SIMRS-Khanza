...
public class DlgKFA extends javax.swing.JDialog {
    ...
    public DlgKFA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode = new DefaultTableModel(null,new Object[]{
            "Kode Barang", "Nama Barang", "Kd.Sat Besar", "Nm.Satuan Besar"
        }) {
            @Override
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKFA dialog = new DlgKFA(new javax.swing.JFrame(), true);
    ...
    Valid.tabelKosong(tabMode);
        try{    
            ps=koneksi.prepareStatement("select product_template_kfa_code, product_template_display_name ,net_weight_uom_name,dosage_form_code from satu_sehat_kfa_master ");
            try {
                ps.setString(1,"%"+TCari.getText().trim()+"%");
                ps.setString(2,"%"+TCari.getText().trim()+"%");
                ps.setString(3,"%"+TCari.getText().trim()+"%");
