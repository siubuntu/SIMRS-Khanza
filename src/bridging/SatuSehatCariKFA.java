 ...
 * @author dosen
 */
public final class SatuSehatCariKFA extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatCariKFA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatCariKFA dialog = new SatuSehatCariKFA(new javax.swing.JFrame(), true);
